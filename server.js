...
async function fetchLongitude(planet, birth, lat, lon, elevation = 0) {
  ...
  const url = `${baseUrl}?format=text&COMMAND='${planet}'&OBJ_DATA='NO'&MAKE_EPHEM='YES'&EPHEM_TYPE='OBSERVER'&CENTER='${center}'&START_TIME='${birth}'&STOP_TIME='${birth}'&STEP_SIZE='1 m'&QUANTITIES='1'`;
